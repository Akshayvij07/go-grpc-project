...
import (
	...
	"github.com/Akshayvij07/go-grpc-project/go-grpc-product-svc/pkg/models"
	pb "github.com/Akshayvij07/go-grpc-project/go-grpc-product-svc/pkg/pb"
)
...
func (s *Server) FindOne(ctx context.Context,req *pb.FindOneRequest) (*pb.FindOneData,error){
	var product models.Product
